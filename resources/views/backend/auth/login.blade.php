                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-600 mb-4">Please login to access the admin dashboard.</p>
                                    </div>
                                    ...
                                    <form class="user" method="POST" action="{{ route('admin.login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user @error('email') is-invalid @enderror"
                                                id="email" placeholder="Enter Email Address..." value="{{ old('email') }}" required autofocus>
                                            @error('email')
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{ route('homepage') }}" target="_blank">
                                            <i class="fas fa-external-link-alt mr-1"></i>View Frontend
                                        </a>
                                    </div>
                                </div>
                            </div>
